...
## 🧭 Project Direction & Maintainer Role

ThermoPilot is actively maintained and guided by its original creator.  
While contributions are welcome, the maintainer reserves the right to:

- review and refine proposed changes  
- request adjustments before merging  
...
To protect the project’s integrity, the following will not be merged:

- changes that modify firmware, voltages, or unsafe system behavior  
- features that conflict with the project’s safety goals  
...
This project welcomes learners, beginners, and experts alike.
...
- telemetry insights or optimization ideas  

---

## 👤 Maintainer Background

ThermoPilot is maintained by a developer with experience in:

- HVAC‑R thermal systems  
- Windows internals and performance behavior  
